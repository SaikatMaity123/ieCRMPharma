          ...
          <ScrollView horizontal style={{margin: 5, padding: 5}}>
            <View style={styles.table}>
              <View style={styles.row}>
                ...
                <Text style={styles.header}>Call0</Text>
                <Text style={styles.header}>Call1</Text>
                <Text style={styles.header}>Call2</Text>
                <Text style={styles.header}>Call3</Text>
              </View>
              {data.map(row => (
                <View style={styles.row}>
                  ...
                  <Text style={styles.cell}>{row.Call0}</Text>
                  <Text style={styles.cell}>{row.Call1}</Text>
                  <Text style={styles.cell}>{row.Call2}</Text>
                  <Text style={styles.cell}>{row.Call3}</Text>
                </View>
              ))}
              <View
                style={{
