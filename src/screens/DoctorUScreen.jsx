...
const DoctorUScreen = props => {
  ...
  const [showGAll, setShowGAll] = useState(false);
        ...
        if (state.isConnected) {
          ...
          if (useManagerAccess === true) {
            const data_api = {
              ...
              IDWorktype: 57,
              //IDDoctor: props.route.params.IDCode,
              IDDoctor: props.route.params.idDoctor,
            ...
            const data_api = {
              ...
              IDCustomer: props.route.params.idDoctor,
              IDEmployee: useIDEmployee,
              Createdby: empEmail,
              Businessid: useBusinessID,
      ...
      NetInfo.fetch().then(async state => {
        if (state.isConnected) {
          ...
          if (useManagerAccess === true) {
            ...
            db.transaction(tx => {
              tx.executeSql(
                'CREATE TABLE IF NOT EXISTS CRM_ManagerDoctorUnlistedDataSave(id INTEGER PRIMARY KEY AUTOINCREMENT, data TEXT);',
                [],
                (_, result) => {
            ...
            db.transaction(tx => {
              tx.executeSql(
                'INSERT INTO CRM_ManagerDoctorUnlistedDataSave(data) VALUES (?);',
            ...
            db.transaction(tx => {
              tx.executeSql(
                'CREATE TABLE IF NOT EXISTS CRM_DoctorUnlistedDataSave(id INTEGER PRIMARY KEY AUTOINCREMENT, data TEXT);',
                [],
                (_, result) => {
                  console.log('Table created successfully:', result);
                },
            ...
            db.transaction(tx => {
              tx.executeSql(
                'INSERT INTO CRM_DoctorUnlistedDataSave(data) VALUES (?);',
                [JSON.stringify(data_api)],
                (_, result) => {
                  console.log('Data inserted successfully:', result);
                  Alert.alert(
          ...
          <View style={{ margin: 10 }}>
            <View style={{ flexDirection: 'row' }}>
              ...
              <TextInput
                ...
                //style={{width: '20%', alignItems: 'center', marginRight: 5}}
                style={[
                  style.textInput,
